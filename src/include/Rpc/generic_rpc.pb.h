...
#ifndef GOOGLE_PROTOBUF_INCLUDED_generic_5frpc_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_generic_5frpc_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_generic_5frpc_2eproto
...
struct TableStruct_generic_5frpc_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_generic_5frpc_2eproto;
namespace GcRpc {
class RpcHeader;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::GcRpc::RpcHeader* Arena::CreateMaybeMessage<::GcRpc::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace GcRpc {
...
class RpcHeader :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:GcRpc.RpcHeader) */ {
 public:
  RpcHeader();
  virtual ~RpcHeader();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_generic_5frpc_2eproto);
    return ::descriptor_table_generic_5frpc_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // @@protoc_insertion_point(class_scope:GcRpc.RpcHeader)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_generic_5frpc_2eproto;
};
// ===================================================================
...
inline const std::string& RpcHeader::service_name() const {
  // @@protoc_insertion_point(field_get:GcRpc.RpcHeader.service_name)
  return _internal_service_name();
}
inline void RpcHeader::set_service_name(const std::string& value) {
  _internal_set_service_name(value);
  // @@protoc_insertion_point(field_set:GcRpc.RpcHeader.service_name)
}
inline std::string* RpcHeader::mutable_service_name() {
  // @@protoc_insertion_point(field_mutable:GcRpc.RpcHeader.service_name)
...
inline void RpcHeader::set_service_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:GcRpc.RpcHeader.service_name)
}
inline void RpcHeader::set_service_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:GcRpc.RpcHeader.service_name)
}
inline void RpcHeader::set_service_name(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:GcRpc.RpcHeader.service_name)
}
...
inline std::string* RpcHeader::release_service_name() {
  // @@protoc_insertion_point(field_release:GcRpc.RpcHeader.service_name)
...
inline void RpcHeader::set_allocated_service_name(std::string* service_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:GcRpc.RpcHeader.service_name)
}
...
inline const std::string& RpcHeader::method_name() const {
  // @@protoc_insertion_point(field_get:GcRpc.RpcHeader.method_name)
  return _internal_method_name();
}
inline void RpcHeader::set_method_name(const std::string& value) {
  _internal_set_method_name(value);
  // @@protoc_insertion_point(field_set:GcRpc.RpcHeader.method_name)
}
inline std::string* RpcHeader::mutable_method_name() {
  // @@protoc_insertion_point(field_mutable:GcRpc.RpcHeader.method_name)
...
inline void RpcHeader::set_method_name(std::string&& value) {
  ...
  method_name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:GcRpc.RpcHeader.method_name)
}
inline void RpcHeader::set_method_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:GcRpc.RpcHeader.method_name)
}
inline void RpcHeader::set_method_name(const void* value, size_t size) {
  ...
  method_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:GcRpc.RpcHeader.method_name)
}
...
inline std::string* RpcHeader::release_method_name() {
  // @@protoc_insertion_point(field_release:GcRpc.RpcHeader.method_name)
...
inline void RpcHeader::set_allocated_method_name(std::string* method_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:GcRpc.RpcHeader.method_name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::args_size() const {
  // @@protoc_insertion_point(field_get:GcRpc.RpcHeader.args_size)
...
inline void RpcHeader::set_args_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:GcRpc.RpcHeader.args_size)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_generic_5frpc_2eproto
